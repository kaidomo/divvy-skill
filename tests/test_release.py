...
class ReleaseMetadataTests(unittest.TestCase):
    ...
    def test_workflows_validate_before_publishing(self) -> None:
        ...
        self.assertIn('test "$GITHUB_SHA" = "$tag_commit"', release)
        self.assertIn('^v(0|[1-9][0-9]*)\\.(0|[1-9][0-9]*)\\.(0|[1-9][0-9]*)$', release)
        ...
        self.assertIn("  verify-tag:\n", release)
        self.assertIn("  publish-tag:\n", release)
        self.assertIn("permissions:\n      contents: read", release.split("  verify-tag:\n", 1)[1].split("  publish-tag:\n", 1)[0])
...
class AutomaticReleaseContractTests(unittest.TestCase):
    ...
    def test_release_comparison_ignores_target_commitish_mismatch(self) -> None:
